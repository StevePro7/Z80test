...
S:Lrecord_screen.screen_record_screen_update$screen_type$1$28({2}DG,SC:U),B,1,4
S:Lrecord_screen.screen_record_screen_update$ro$1$29({2}DG,STtag_struct_record_object:S),R,0,0,[]
S:Lrecord_screen.screen_record_screen_update$input1$1$29({1}SC:U),R,0,0,[l]
S:Lrecord_screen.screen_record_screen_update$input2$1$29({1}SC:U),R,0,0,[l]
