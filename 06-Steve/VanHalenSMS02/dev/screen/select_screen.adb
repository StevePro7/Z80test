...
S:Lselect_screen.screen_select_screen_load$so$1$27({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
F:G$screen_select_screen_update$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lselect_screen.screen_select_screen_update$screen_type$1$29({2}DG,SC:U),B,1,4
S:Lselect_screen.screen_select_screen_update$input$1$30({1}SC:U),R,0,0,[]
S:Lselect_screen.screen_select_screen_update$index$1$30({1}SC:U),R,0,0,[b]
